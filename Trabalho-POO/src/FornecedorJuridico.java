...
public class FornecedorJuridico extends PessoaJuridica{
	public FornecedorJuridico (int pessoa_id, String razao, String fantasia, long cnpj, long tel, boolean status, Endereco endereco){
	...
	public FornecedorJuridico(ArrayList<String> M){
