...
public class NFEntradaJuridico extends NotaFiscal{
	public FornecedorJuridico fornecedor;
	public NFEntradaJuridico(int nota_id, int data, FornecedorJuridico cliente,Produto p){
		this.nota_id = nota_id;
		this.data = data;
		this.fornecedor = cliente;
		this.produtos = p;
	}
	public NFEntradaJuridico(ArrayList<String>n){
		BD b = new BD();
		...
		this.fornecedor = new FornecedorJuridico(f);
		
		//NotaEntradaFisicoProduto
		ArrayList<String> p = b.pesquisa(this.nota_id, "NotaEntradaJuridicoProduto");
		this.produtos = new Produto(p);
	}
	public NFEntradaJuridico(){
		super("NotaEntradaJuridico");
		
		this.fornecedor = new FornecedorJuridico();
		this.produtos = new Produto();
	}
	public NFEntradaJuridico(int fornecedorId, int produtoId){
		super("NotaEntradaJuridico");
